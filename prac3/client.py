...
host2='192.168.3.3'  #modify the ip addr as you need 
port2=12346          #(MAIN SERVER, port that gives the BOOKS)
sock2 = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
sock2.connect((host2,port2))

host3='192.168.3.3'  #modify the ip addr as you need 
...
host5='192.168.3.3'  #modify the ip addr as you need 
...
host6='192.168.3.3'  #modify the ip addr as you need (server)
